...
fn turn_on(l: &mut u32) {
    *l |= 1
}
fn turn_off(l: &mut u32) {
    *l &= 0
}
fn toggle(l: &mut u32) {
    *l ^= 1
...
fn increase(l: &mut u32) {
    *l += 1
}
fn decrease(l: &mut u32) {
    *l = l.saturating_sub(1)
}
fn increase2(l: &mut u32) {
    *l += 2
}

fn part_1(input: Vec<(usize, usize, u8)>) -> u32 {
    ...
    F: Fn(u8) -> fn(&mut u32),
{
    ...
    grid.iter().flat_map(|r| r.iter()).sum()
}
